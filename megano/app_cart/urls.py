...
urlpatterns = [
	...
	path('reduce#<int:good>&<int:cart>/', CartView.reduce_quantity, name='reduce_quantity'),
	# Это путь к странице увеличения количества товаров в корзине.
	path('increase#<int:good>&<int:cart>/', CartView.increase_quantity, name='increase_quantity'),
	...
	path('remove#<int:good>&<int:cart>/', CartView.remove_from_cart, name='remove_from_cart'),
]
